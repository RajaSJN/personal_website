...
import projects__chronarkComMdx from "./projects__chronark.com.mdx.json" assert {
	type: "json",
};
import projects__envshareMdx from "./projects__envshare.mdx.json" assert {
	type: "json",
};
import projects__highstormMdx from "./projects__highstorm.mdx.json" assert {
	type: "json",
};
...
import projects__unkeyMdx from "./projects__unkey.mdx.json" assert {
	type: "json",
};
...
import projects__zodBirdMdx from "./projects__zod-bird.mdx.json" assert {
	type: "json",
};

export const allProjects = [
	projects__accessMdx,
	projects__chronarkComMdx,
	projects__envshareMdx,
	projects__highstormMdx,
